...
public class Announcer : MonoBehaviour
{
    ...
    public void Interception() => audioSource.PlayOneShot(interception[Random.Range(0,1)]);
    public void MissClose() => audioSource.PlayOneShot(missClose[Random.Range(0, 1)]);
